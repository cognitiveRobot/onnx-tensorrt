...
# python3.6
# Cuda11.0.167 cuBLAS 11.1.0
# cuDNN 8.0.1
FROM nvcr.io/nvidia/tensorrt:20.06-py3
# ARG TENSORRT_VERSION=7.1.2
ARG PY3_VERSION=36
...
# need cmake>3.13. apt can't do that.
...
# RUN pip2 install onnx==1.6 pytest==4.6.5
RUN pip3 install onnx==1.6 pytest==5.1.2
